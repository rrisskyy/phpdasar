...
<body>
    ...
    <ul>
        ...
        <li>
            <a href="latihan2.php?name=<?= $member["name"]?>&rank=<?= $member["rank"]?>&power=<?= $member["power"]?>&skill=<?= $member["skill"]?>&grimoire=<?= $member["grimoire"]?>&position=<?= $member["position"]?>&img=<?= $member["img"]?>">
            <?= $member["name"]?></a>
        </li>
        <br>
        <?php endforeach;?>
