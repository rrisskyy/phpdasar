...
<link href="bootstrap-4.5.3-dist/css/bootstrap.min.css" rel="stylesheet">
  ...
  <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="blackclover.php">Black Clover</a>
  <button class="navbar-toggler position-absolute d-md-none collapsed" type="button" data-toggle="collapse" data-target="#sidebarMenu" aria-controls="sidebarMenu" aria-expanded="false" aria-label="Toggle navigation">
    <span class="navbar-toggler-icon"></span>
  </button>
  <form class="w-100" action="" method="get">
  <?php if ( isset($_GET['search'])): ?>
  <input class="form-control form-control-dark" type="text" placeholder="Search" name="search" aria-label="Search Keyword" autofocus autocomplete="off" value="<?= $_GET['search'] ?>">
  <?php else: ?>
      ...
      <div class="table-responsive">
        <table class="table table-striped table-sm">
          ...
          <?php if(count($blbuls) === 0) : ?>
            <h2 class="featurette-heading">Data tidak ditemukan!</h2> <a class="text-muted" href="blackclover.php"><?= $house ?>Kembali ke Halaman Utama</a>
            <?php endif; ?>
          </tr>  
          </tbody>
        </table>
